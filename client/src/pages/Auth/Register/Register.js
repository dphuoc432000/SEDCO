...
class Register extends React.Component {
  ...
  handleRegister = async () => {
    ...
    const regisActionType = await this.props.register(this.state.user_infor)
      .type;
              ...
              <div className="account_infor">
                ...
                <div className="input_username">
                  <input
                    ...
                    onChange={(event) => {
                      this.onChangeRegisterForm(event);
                    }}
                ...
                <div className="input_password_again">
                  <input
                    ...
                    onChange={(event) => {
                      this.onChangePasswordAgain(event);
                    }}
                ...
                <div className="input_address">
                  ...
                  <div className="input_district">
                    <select
                      ...
                      name="district"
                      onChange={(event) => {
                        this.onChangeDistrictSelect(event);
                      }}
                    >
                      <option value="" value>
                        Chọn quận/huyện
