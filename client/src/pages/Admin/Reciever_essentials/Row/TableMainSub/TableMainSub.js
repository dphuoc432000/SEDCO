    ...
    render() {
        ...
        return (
            <table className={TableMainSubCss.table_main__sub}>
                <tbody>
                    <tr>
                        <th className={TableMainSubCss.tb_main_sub_column_title}>Số người trong hộ gia đình</th>
                        <td className={TableMainSubCss.tb_main_sub_column_data}>{status.detail.number_per_of_family}</td>
                    </tr>
                    <tr>
