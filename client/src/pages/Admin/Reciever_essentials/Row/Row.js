...
class Row extends Component {
    ...
    render() {
        ...
        return (
            <React.Fragment>
                <tr className={RecieverEssentialsCss.table_main_row_data}>
                    ...
                    <td><p className={RecieverEssentialsCss.btn_information} onClick={()=>{this.handleShowTableMainSub()}}>{showTableMainSub?'Đóng':'Chi tiết'}</p></td>
                </tr>
                {
                    showTableMainSub &&
                    <tr className={RecieverEssentialsCss.table_main_row__table_sub}>
                        <td  colSpan='5'>
